...
function StoreAlbums() {
    ...
    const filteredAlbums = useMemo(() => {
        ...
        const autoMin = numericPrices.length
            ? Math.min(...numericPrices)
            : 0;
        const autoMax = numericPrices.length
                ...
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1">
                            Browse K-pop albums, filter by group, price, and
                            stock, then add them to your cart.
                        </p>
                    </div>

                    <div className="hidden md:block">
                        <label className="text-[11px] text-slate-400 mr-2">
                            Sort
                        </label>
