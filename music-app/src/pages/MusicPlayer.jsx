...
function MusicPlayer() {
  ...
  // playlist 邏輯
  const { playlists, playlistFilter, playlistItems, handlePlaylistSelect } =
    ...
    <div className="flex flex-col gap-4 w-full px-8">
      <header>
        ...
        <p className="text-sm text-slate-400 mt-1">
          Browse songs from your database, play them, and see what is coming
          next.
        </p>
      </header>
      ...
      <section className="bg-slate-900 rounded-xl p-4 grid grid-cols-1 lg:grid-cols-[1.4fr,1.6fr] gap-4">
        ...
        <div className="flex flex-col gap-3 border-r border-slate-800 pr-2">
          ...
          <VideoList
            ...
            error={error}
            currentVideoId={
              currentVideo && currentVideo.id > 0 ? currentVideo.id : null
            }
