            ...
            <div className="mb-6">
                ...
                <div className="flex gap-2 mt-2">
                    <button
                        ...
                        className={`flex-1 rounded-full border px-3 py-1 text-[11px] ${availability === "in_stock"
                    ...
                    <button
                        ...
                        className={`flex-1 rounded-full border px-3 py-1 text-[11px] ${availability === "out_of_stock"
                                ? "bg-slate-100 text-slate-900 border-slate-100"
                                : "border-slate-600 text-slate-200"
                            }`}
                    >
                    ...
                    {groupOptions.map((name) => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full flex items-center justify-between rounded-md px-2 py-1 text-[11px] ${active
