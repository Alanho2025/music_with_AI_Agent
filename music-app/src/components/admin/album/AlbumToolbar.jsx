        ...
        <div className="mb-4 flex flex-wrap items-end gap-3 rounded-xl border border-slate-800 bg-slate-950 px-4 py-3">
            ...
            <div className="flex flex-col gap-1">
                ...
                <select
                    ...
                    onChange={(e) =>
                        handleFilterPatch({ groupId: e.target.value })
                    }
            ...
            <div className="flex flex-col gap-1">
                ...
                <select
                    ...
                    onChange={(e) =>
                        handleFilterPatch({ country: e.target.value })
                    }
                    className="min-w-[140px] rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-slate-100"
                >
            ...
            <div className="flex flex-col gap-1">
                ...
                <input
                    ...
                    onChange={(e) =>
                        handleFilterPatch({ releaseFrom: e.target.value })
                    }
            ...
            <div className="flex flex-col gap-1">
                ...
                <input
                    ...
                    onChange={(e) =>
                        handleFilterPatch({ releaseTo: e.target.value })
                    }
                    className="rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-slate-100"
                />
            </div>
