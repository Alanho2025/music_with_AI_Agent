...
function IdolToolbar({ search, onSearchChange, filters, onFilterChange, groups }) {
        ...
        <div className="mb-4 flex flex-wrap items-end gap-3 rounded-xl border border-slate-800 bg-slate-950 px-4 py-3">
            ...
            <div className="flex flex-col gap-1">
                ...
                <input
                    ...
                    onChange={(e) =>
                        updateFilters({ birthFrom: e.target.value })
                    }
            ...
            <div className="flex flex-col gap-1">
                ...
                <select
                    ...
                    onChange={(e) =>
                        updateFilters({ imageStatus: e.target.value })
                    }
