...
function UrlImportPanel() {
  ...
  async function handleImport() {
    ...
    try {
      ...
      setIdols(
        idolList.length ? idolList.map((i) => ({ ...emptyIdol, ...i })) : []
      );

      const albumList = Array.isArray(parsed.albums) ? parsed.albums : [];
      setAlbums(
        albumList.length ? albumList.map((a) => ({ ...emptyAlbum, ...a })) : []
      );
    } catch (err) {
  ...
  function updateIdolField(index, field, value) {
    setIdols((prev) =>
      prev.map((idol, i) => (i === index ? { ...idol, [field]: value } : idol))
    );
  }
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 p-4 rounded-lg flex flex-col gap-4">
      ...
      {/* GROUP FORM */}
      <div className="mt-2">
        <h3 className="text-sm font-semibold mb-2 text-slate-200">Group</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              onChange={(e) => updateGroupField('korean_name', e.target.value)}
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              onChange={(e) => updateGroupField('debut_date', e.target.value)}
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              className="bg-slate-800 px-2 py-1 rounded"
              value={group.company}
              onChange={(e) => updateGroupField('company', e.target.value)}
            />
          </div>

          <div className="flex flex-col gap-1">
            <label className="text-slate-400">Fanclub name</label>
            <input
              className="bg-slate-800 px-2 py-1 rounded"
              value={group.fanclub_name}
              onChange={(e) => updateGroupField('fanclub_name', e.target.value)}
            />
          </div>

          <div className="flex flex-col gap-1">
            <label className="text-slate-400">Members count</label>
            <input
              type="number"
              className="bg-slate-800 px-2 py-1 rounded"
              value={group.members_count || ''}
              onChange={(e) =>
                updateGroupField('members_count', e.target.value)
              }
            />
          </div>

          <div className="flex flex-col gap-1">
            <label className="text-slate-400">Original members</label>
            <input
              className="bg-slate-800 px-2 py-1 rounded"
              value={group.original_members}
              onChange={(e) =>
                updateGroupField('original_members', e.target.value)
              }
            />
          </div>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-sm font-semibold text-slate-200">Idols</h3>
          <button
            type="button"
            onClick={addIdol}
          ...
          {idols.map((idol, index) => (
            ...
            >
              <div className="flex justify-between items-center">
                <span className="font-semibold">Idol #{index + 1}</span>
                <button
                  type="button"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                <input
                  ...
                  onChange={(e) =>
                    updateIdolField(index, 'stage_name', e.target.value)
                  }
                />
                <input
                  className="bg-slate-800 px-2 py-1 rounded"
                  ...
                  onChange={(e) =>
                    updateIdolField(index, 'birth_name', e.target.value)
                  }
                />
                <input
                  className="bg-slate-800 px-2 py-1 rounded"
                  ...
                  onChange={(e) =>
                    updateIdolField(index, 'korean_name', e.target.value)
                  }
                />
                <input
                  className="bg-slate-800 px-2 py-1 rounded"
                  ...
                  value={idol.position}
                  onChange={(e) =>
                    updateIdolField(index, 'position', e.target.value)
                  }
                />
                <input
                  className="bg-slate-800 px-2 py-1 rounded"
                  ...
                  onChange={(e) =>
                    updateIdolField(index, 'birthdate', e.target.value)
                  }
                />
                <input
                  className="bg-slate-800 px-2 py-1 rounded"
                  ...
                  onChange={(e) =>
                    updateIdolField(index, 'nationality', e.target.value)
                  }
                />
                <input
                  ...
                  onChange={(e) =>
                    updateIdolField(index, 'image_url', e.target.value)
                  }
                />
              </div>
            </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-sm font-semibold text-slate-200">Albums</h3>
          <button
            type="button"
            onClick={addAlbum}
            className="text-xs px-2 py-1 rounded bg-slate-800 hover:bg-slate-700"
        ...
        <div className="flex flex-col gap-3 max-h-64 overflow-auto">
          {albums.map((album, index) => (
            ...
            >
              <div className="flex justify-between items-center">
                <span className="font-semibold">Album #{index + 1}</span>
                <button
                  type="button"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                <input
                  ...
                  value={album.title}
                  onChange={(e) =>
                    updateAlbumField(index, 'title', e.target.value)
                  }
                />
                <input
                  className="bg-slate-800 px-2 py-1 rounded"
                  ...
                  onChange={(e) =>
                    updateAlbumField(index, 'release_date', e.target.value)
                  }
                />
                <input
                  className="bg-slate-800 px-2 py-1 rounded"
                  ...
                  value={album.country}
                  onChange={(e) =>
                    updateAlbumField(index, 'country', e.target.value)
                  }
                />
                <input
                  className="bg-slate-800 px-2 py-1 rounded"
                  ...
                  value={album.sales}
                  onChange={(e) =>
                    updateAlbumField(index, 'sales', e.target.value)
                  }
                />
                <input
                  className="bg-slate-800 px-2 py-1 rounded"
                  ...
                  onChange={(e) =>
                    updateAlbumField(index, 'peak_chart', e.target.value)
                  }
                />
              </div>
            </div>
